...
so overall these are all the forms with the baar on with the given functionality mentioned 
1.add a new customer 
2.Add a new area overall mostly for the first time 
3.debit customer like (for the exter charges after day 10 )
